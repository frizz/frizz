...
func init() {
	...
	system.RegisterType("kego.io/system", "@aliases", ptr1)
	system.RegisterType("kego.io/system", "@array", ptr14)
	system.RegisterType("kego.io/system", "@base", ptr16)
	system.RegisterType("kego.io/system", "@bool", ptr21)
	system.RegisterType("kego.io/system", "@imports", ptr23)
	system.RegisterType("kego.io/system", "@int", ptr37)
	system.RegisterType("kego.io/system", "@map", ptr47)
	system.RegisterType("kego.io/system", "@number", ptr67)
	system.RegisterType("kego.io/system", "@reference", ptr72)
	system.RegisterType("kego.io/system", "@rule", ptr74)
	system.RegisterType("kego.io/system", "@ruleBase", ptr76)
	system.RegisterType("kego.io/system", "@string", ptr101)
	system.RegisterType("kego.io/system", "@type", ptr103)
	system.RegisterType("kego.io/system", "aliases", ptr109)
	system.RegisterType("kego.io/system", "array", ptr111)
	system.RegisterType("kego.io/system", "base", ptr126)
	system.RegisterType("kego.io/system", "bool", ptr128)
	system.RegisterType("kego.io/system", "imports", ptr134)
	system.RegisterType("kego.io/system", "int", ptr136)
	system.RegisterType("kego.io/system", "map", ptr138)
	system.RegisterType("kego.io/system", "number", ptr140)
	system.RegisterType("kego.io/system", "reference", ptr142)
	system.RegisterType("kego.io/system", "rule", ptr144)
	system.RegisterType("kego.io/system", "ruleBase", ptr152)
	system.RegisterType("kego.io/system", "string", ptr154)
	system.RegisterType("kego.io/system", "type", ptr186)
}
