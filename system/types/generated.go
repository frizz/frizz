...
func init() {
	...
	ptr23 := &system.Base{Description: "This provides an upper bound for the restriction", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@int", Exists: true}}
	...
	ptr29 := &system.Base{Description: "This restricts the number to be a multiple of the given number", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@int", Exists: true}}
	...
	ptr35 := &system.Type{Base: ptr22, Embed: []system.Reference{system.Reference{Package: "kego.io/system", Name: "ruleBase", Exists: true}}, Fields: map[string]system.Rule{"maximum": ptr25, "default": ptr28, "multipleOf": ptr31, "minimum": ptr34}, Is: []system.Reference{system.Reference{Package: "kego.io/system", Name: "rule", Exists: true}}, Native: system.String{Value: "object", Exists: true}, Rule: (*system.Type)(nil)}
	...
	ptr37 := &system.Base{Description: "This is the minimum number of items alowed in the array", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@int", Exists: true}}
	ptr38 := &system.RuleBase{Optional: true}
	ptr39 := &system.Int_rule{Base: ptr37, RuleBase: ptr38, Default: system.Int{Value: 0}, Maximum: system.Int{Value: 0}, Minimum: system.Int{Value: 0, Exists: true}, MultipleOf: system.Int{Value: 0}}
	ptr40 := &system.Base{Description: "This is the maximum number of items alowed in the array", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@int", Exists: true}}
	ptr41 := &system.RuleBase{Optional: true}
	ptr42 := &system.Int_rule{Base: ptr40, RuleBase: ptr41, Default: system.Int{Value: 0}, Maximum: system.Int{Value: 0}, Minimum: system.Int{Value: 0, Exists: true}, MultipleOf: system.Int{Value: 0}}
	ptr43 := &system.Base{Description: "This is a rule object, defining the type and restrictions on the value of the items.", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@rule", Exists: true}}
	ptr44 := &system.Rule_rule{Base: ptr43, RuleBase: (*system.RuleBase)(nil)}
	ptr45 := &system.Type{Base: ptr36, Embed: []system.Reference{system.Reference{Package: "kego.io/system", Name: "ruleBase", Exists: true}}, Fields: map[string]system.Rule{"minItems": ptr39, "maxItems": ptr42, "items": ptr44}, Is: []system.Reference{system.Reference{Package: "kego.io/system", Name: "rule", Exists: true}}, Native: system.String{Value: "object", Exists: true}, Rule: (*system.Type)(nil)}
	...
	ptr105 := &system.Base{Description: "Type of the object.", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@reference", Exists: true}}
	ptr106 := &system.Reference_rule{Base: ptr105, RuleBase: (*system.RuleBase)(nil), Default: system.Reference{}}
	ptr107 := &system.Base{Description: "All global objects should have an id.", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@reference", Exists: true}}
	ptr108 := &system.RuleBase{Optional: true}
	ptr109 := &system.Reference_rule{Base: ptr107, RuleBase: ptr108, Default: system.Reference{}}
	ptr110 := &system.Base{Description: "Description for the developer", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/json", Name: "@string", Exists: true}}
	ptr111 := &system.RuleBase{Optional: true}
	ptr112 := &system.JsonString_rule{Base: ptr110, RuleBase: ptr111}
	ptr113 := &system.Base{Description: "Extra validation rules for this object or descendants", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@array", Exists: true}}
	ptr114 := &system.RuleBase{Optional: true}
	ptr115 := &system.Base{Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@rule", Exists: true}}
	ptr116 := &system.Rule_rule{Base: ptr115, RuleBase: (*system.RuleBase)(nil)}
	ptr117 := &system.Array_rule{Base: ptr113, RuleBase: ptr114, Items: ptr116, MaxItems: system.Int{Value: 0}, MinItems: system.Int{Value: 0}}
	ptr118 := &system.Type{Base: ptr104, Basic: true, Embed: []system.Reference(nil), Fields: map[string]system.Rule{"type": ptr106, "id": ptr109, "description": ptr112, "rules": ptr117}, Is: []system.Reference(nil), Native: system.String{Value: "object", Exists: true}, Rule: (*system.Type)(nil)}
	...
	ptr148 := &system.Base{Description: "Each field is listed with it's type", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@map", Exists: true}}
	ptr149 := &system.RuleBase{Optional: true}
	ptr150 := &system.Base{Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@rule", Exists: true}}
	ptr151 := &system.Rule_rule{Base: ptr150, RuleBase: (*system.RuleBase)(nil)}
	ptr152 := &system.Map_rule{Base: ptr148, RuleBase: ptr149, Items: ptr151, MaxItems: system.Int{Value: 0}, MinItems: system.Int{Value: 0}}
	ptr153 := &system.Base{Description: "Embedded type that defines restriction rules for this type. By convention, the ID should be this type prefixed with the @ character.", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@type", Exists: true}}
	ptr154 := &system.RuleBase{Optional: true}
	ptr155 := &system.Type_rule{Base: ptr153, RuleBase: ptr154}
	...
	ptr164 := &system.Base{Description: "Array of interface types that this type should support", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@array", Exists: true}}
	ptr165 := &system.RuleBase{Optional: true}
	ptr166 := &system.Base{Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@reference", Exists: true}}
	ptr167 := &system.Reference_rule{Base: ptr166, RuleBase: (*system.RuleBase)(nil), Default: system.Reference{}}
	ptr168 := &system.Array_rule{Base: ptr164, RuleBase: ptr165, Items: ptr167, MaxItems: system.Int{Value: 0}, MinItems: system.Int{Value: 0}}
	ptr169 := &system.Base{Description: "This is the native json type that represents this type. If omitted, default is object.", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "@string", Exists: true}}
	ptr170 := &system.RuleBase{Optional: true}
	ptr171 := &system.String_rule{Base: ptr169, RuleBase: ptr170, Default: system.String{Value: "object", Exists: true}, Enum: []string{"string", "number", "bool", "array", "object", "map"}, Equal: system.String{}, Format: system.String{}, MaxLength: system.Int{Value: 0}, MinLength: system.Int{Value: 0}, Pattern: system.String{}}
	...
	ptr175 := &system.Base{Description: "Exclude this type from the generated json?", Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/json", Name: "@bool", Exists: true}}
	ptr176 := &system.RuleBase{Optional: true}
	ptr177 := &system.JsonBool_rule{Base: ptr175, RuleBase: ptr176}
	ptr178 := &system.Type{Base: ptr147, Embed: []system.Reference(nil), Fields: map[string]system.Rule{"fields": ptr152, "rule": ptr155, "basic": ptr158, "embed": ptr163, "is": ptr168, "native": ptr171, "interface": ptr174, "exclude": ptr177}, Is: []system.Reference(nil), Native: system.String{Value: "object", Exists: true}, Rule: (*system.Type)(nil)}
