...
func init() {
	...
	system.RegisterType("kego.io/system", "@array", ptr15, 0x9396ab3adc9b26c2)
	system.RegisterType("kego.io/system", "@base", ptr17, 0x55165bf6126129f)
	system.RegisterType("kego.io/system", "@bool", ptr22, 0x18e72064215d8f71)
	system.RegisterType("kego.io/system", "@imports", ptr24, 0x9bb5dc657899f549)
	system.RegisterType("kego.io/system", "@int", ptr38, 0xe7b98d2f66bb5b1)
	system.RegisterType("kego.io/system", "@map", ptr49, 0x68d11e9fab3ed4bb)
	system.RegisterType("kego.io/system", "@number", ptr69, 0x8c2b0d23320b8aeb)
	system.RegisterType("kego.io/system", "@reference", ptr74, 0x2a5ddf0f63b58876)
	system.RegisterType("kego.io/system", "@rule", ptr76, 0x50ad825a1446eccd)
	system.RegisterType("kego.io/system", "@ruleBase", ptr78, 0xab213a8c8218179a)
	system.RegisterType("kego.io/system", "@string", ptr104, 0xae4613a6af2bb7d6)
	system.RegisterType("kego.io/system", "@type", ptr106, 0xc1bba2c7da9518b7)
	system.RegisterType("kego.io/system", "aliases", ptr114, 0xa201259ad19e56d5)
	system.RegisterType("kego.io/system", "array", ptr116, 0x9396ab3adc9b26c2)
	system.RegisterType("kego.io/system", "base", ptr133, 0x55165bf6126129f)
	system.RegisterType("kego.io/system", "bool", ptr135, 0x18e72064215d8f71)
	system.RegisterType("kego.io/system", "imports", ptr143, 0x9bb5dc657899f549)
	system.RegisterType("kego.io/system", "int", ptr145, 0xe7b98d2f66bb5b1)
	system.RegisterType("kego.io/system", "map", ptr147, 0x68d11e9fab3ed4bb)
	system.RegisterType("kego.io/system", "number", ptr149, 0x8c2b0d23320b8aeb)
	system.RegisterType("kego.io/system", "reference", ptr151, 0x2a5ddf0f63b58876)
	system.RegisterType("kego.io/system", "rule", ptr153, 0x50ad825a1446eccd)
	system.RegisterType("kego.io/system", "ruleBase", ptr161, 0xab213a8c8218179a)
	system.RegisterType("kego.io/system", "string", ptr163, 0xae4613a6af2bb7d6)
	system.RegisterType("kego.io/system", "type", ptr198, 0xc1bba2c7da9518b7)
}
