// info:{"Path":"kego.io/process/validate/selectors/tests","Hash":9397774896687891332}
package tests
...
func init() {
	pkg := jsonctx.InitPackage("kego.io/process/validate/selectors/tests", 9397774896687891332)
