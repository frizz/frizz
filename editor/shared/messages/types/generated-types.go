...
func init() {
	...
	ptr30 := &system.Type{Object: ptr20, Basic: true, Embed: []*system.Reference(nil), Fields: map[string]system.RuleInterface{"guid": ptr24, "request": ptr28}, Is: []*system.Reference(nil), Native: &ptr29, Rule: (*system.Type)(nil)}
	...
	ptr40 := &system.Type{Object: ptr33, Embed: []*system.Reference{ptr34}, Fields: map[string]system.RuleInterface{"name": ptr38}, Is: []*system.Reference(nil), Native: &ptr39, Rule: (*system.Type)(nil)}
	...
	ptr58 := &system.Type{Object: ptr43, Embed: []*system.Reference{ptr44}, Fields: map[string]system.RuleInterface{"data": ptr48, "found": ptr52, "name": ptr56}, Is: []*system.Reference(nil), Native: &ptr57, Rule: (*system.Type)(nil)}
