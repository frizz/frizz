...
func init() {
	...
	json.Register("kego.io/selectors/tests", "@diagram", reflect.TypeOf((*DiagramRule)(nil)), nil, 16444553391241319746)
	...
	json.Register("kego.io/selectors/tests", "@photo", reflect.TypeOf((*PhotoRule)(nil)), nil, 12437933635632219380)
	...
	json.Register("kego.io/selectors/tests", "diagram", reflect.TypeOf((*Diagram)(nil)), reflect.TypeOf((*DiagramInterface)(nil)).Elem(), 16444553391241319746)
	...
	json.Register("kego.io/selectors/tests", "photo", reflect.TypeOf((*Photo)(nil)), reflect.TypeOf((*PhotoInterface)(nil)).Elem(), 12437933635632219380)
