...
func init() {
	...
	system.RegisterType("kego.io/selectors/tests", "@simple", ptr35, 0x7054dc6469f4db46)
	system.RegisterType("kego.io/selectors/tests", "@simpleItem", ptr37, 0xac167d73687ccb1f)
	system.RegisterType("kego.io/selectors/tests", "@typed", ptr39, 0x216d0e1d4c22bb2d)
	system.RegisterType("kego.io/selectors/tests", "basic", ptr74, 0xe2f725e9d48b69d4)
	system.RegisterType("kego.io/selectors/tests", "c", ptr88, 0x6a4bf0b03046c68a)
	system.RegisterType("kego.io/selectors/tests", "collision", ptr96, 0x2f6382cf84b27ee7)
	system.RegisterType("kego.io/selectors/tests", "diagram", ptr101, 0x2076b0eaf334855b)
	system.RegisterType("kego.io/selectors/tests", "expr", ptr124, 0x6214e678b1df35e3)
	system.RegisterType("kego.io/selectors/tests", "gallery", ptr132, 0xa2261dbb985b3d3)
	system.RegisterType("kego.io/selectors/tests", "image", ptr134, 0x2a2a6f416ac31013)
	system.RegisterType("kego.io/selectors/tests", "instance", ptr151, 0x91954502a09aa42a)
	system.RegisterType("kego.io/selectors/tests", "instanceItem", ptr156, 0x2dca71ec3918c621)
	system.RegisterType("kego.io/selectors/tests", "kid", ptr167, 0x3b576fd38b04a2eb)
	system.RegisterType("kego.io/selectors/tests", "photo", ptr181, 0x9b14a4b75f8931a8)
	system.RegisterType("kego.io/selectors/tests", "polykids", ptr189, 0xebaffecb552df4d1)
	system.RegisterType("kego.io/selectors/tests", "rectangle", ptr197, 0x21539507256190ab)
	system.RegisterType("kego.io/selectors/tests", "rightscale", ptr208, 0x19db6e12b53f9744)
	system.RegisterType("kego.io/selectors/tests", "rightscaleLink", ptr216, 0x127d9489c45697ea)
	system.RegisterType("kego.io/selectors/tests", "rightscaleList", ptr224, 0x6a9527067852e20b)
	system.RegisterType("kego.io/selectors/tests", "sibling", ptr247, 0xac837d672ff74ed6)
	system.RegisterType("kego.io/selectors/tests", "simple", ptr252, 0x7054dc6469f4db46)
	system.RegisterType("kego.io/selectors/tests", "simpleItem", ptr257, 0xac167d73687ccb1f)
	system.RegisterType("kego.io/selectors/tests", "typed", ptr286, 0x216d0e1d4c22bb2d)
}
