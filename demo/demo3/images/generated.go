// info:{"Path":"frizz.io/demo/demo3/images","Hash":8390227469870486636}
package images
...
func (v *PhotoRule) Unpack(ctx context.Context, in system.Packed, iface bool) error {
	...
	if err := v.Object.InitializeType("frizz.io/demo/demo3/images", "@photo"); err != nil {
		return err
	}
	if v.Rule == nil {
...
func (v *PhotoRule) Repack(ctx context.Context) (data interface{}, typePackage string, typeName string, jsonType system.JsonType, err error) {
	if v == nil {
		return nil, "frizz.io/demo/demo3/images", "@photo", system.J_NULL, nil
	}
	...
	return m, "frizz.io/demo/demo3/images", "@photo", system.J_OBJECT, nil
}
...
func UnpackPhotoInterface(ctx context.Context, in system.Packed) (PhotoInterface, error) {
	switch in.Type() {
	case system.J_MAP:
		i, err := system.UnpackUnknownType(ctx, in, true, "frizz.io/demo/demo3/images", "photo")
		if err != nil {
			return nil, err
		}
...
func init() {
	pkg := jsonctx.InitPackage("frizz.io/demo/demo3/images")
	pkg.SetHash(uint64(0x7470136e365ad46c))
