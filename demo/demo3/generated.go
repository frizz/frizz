// info:{"Path":"frizz.io/demo/demo3","Hash":11021035902409697387}
package demo3
...
import (
	...
	images "frizz.io/demo/demo3/images"
...
func (v *PageRule) Unpack(ctx context.Context, in system.Packed, iface bool) error {
	...
	if err := v.Object.InitializeType("frizz.io/demo/demo3", "@page"); err != nil {
		return err
	}
	if v.Rule == nil {
...
func (v *PageRule) Repack(ctx context.Context) (data interface{}, typePackage string, typeName string, jsonType system.JsonType, err error) {
	if v == nil {
		return nil, "frizz.io/demo/demo3", "@page", system.J_NULL, nil
	}
	...
	return m, "frizz.io/demo/demo3", "@page", system.J_OBJECT, nil
}
...
func UnpackPageInterface(ctx context.Context, in system.Packed) (PageInterface, error) {
	switch in.Type() {
	case system.J_MAP:
		i, err := system.UnpackUnknownType(ctx, in, true, "frizz.io/demo/demo3", "page")
		if err != nil {
			return nil, err
		}
...
func init() {
	pkg := jsonctx.InitPackage("frizz.io/demo/demo3")
	pkg.SetHash(uint64(0x98f295c2e3f4e86b))
