// info:{"Path":"frizz.io/demo/demo2","Hash":5277376379671719742}
package demo2
...
func (v *PageRule) Unpack(ctx context.Context, in system.Packed, iface bool) error {
	...
	if err := v.Object.InitializeType("frizz.io/demo/demo2", "@page"); err != nil {
		return err
	}
	if v.Rule == nil {
...
func (v *PageRule) Repack(ctx context.Context) (data interface{}, typePackage string, typeName string, jsonType system.JsonType, err error) {
	if v == nil {
		return nil, "frizz.io/demo/demo2", "@page", system.J_NULL, nil
	}
	...
	return m, "frizz.io/demo/demo2", "@page", system.J_OBJECT, nil
}
...
func UnpackPageInterface(ctx context.Context, in system.Packed) (PageInterface, error) {
	switch in.Type() {
	case system.J_MAP:
		i, err := system.UnpackUnknownType(ctx, in, true, "frizz.io/demo/demo2", "page")
		if err != nil {
			return nil, err
		}
