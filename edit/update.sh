...
cp "$GOPATH"/pkg/*_js_min/github.com/gopherjs/gopherjs/js.a assets/assets/static/pkg/github.com/gopherjs/gopherjs/js.a
cp "$GOPATH"/pkg/*_js_min/github.com/gopherjs/gopherjs/nosync.a assets/assets/static/pkg/github.com/gopherjs/gopherjs/nosync.a
...
cp -a "$GOROOT"/pkg/*_js_min/* assets/assets/static/pkg/
cp -a "$GOROOT"/pkg/*_amd64_js_min/* assets/assets/static/pkg/

# Rename all *.a files in pkg/ to *.a.
# find assets/assets/static/pkg -name "*.a" -exec sh -c 'mv $0 $0.js' {} \;
