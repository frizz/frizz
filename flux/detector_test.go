...
type mockStore1 struct{ *Store }
type mockStore2 struct{ *Store }
type mockStore3 struct{ *Store }
type mockStore4 struct{ *Store }
type mockStore5 struct{ *Store }
type mockStore6 struct{ *Store }
